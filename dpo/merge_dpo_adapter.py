...
def get_args():
    ...
    parser.add_argument("-b","--base_model_name_or_path", type=str)
    parser.add_argument("-p","--peft_model_path",type=str)
...
def main():
    ...
    with open(os.path.join(save_dir, f"info.txt"), "w") as f:
        ...
        f.write(f"Model saved to {args.save_dir}")
        f.close()
